...
LibHTTP is often used as HTTP and HTTPS library inside a larger application.  A C API is available to integrate the LibHTTP functionality in a larger codebase. This document describes the public C API. Basic usage examples of the API can be found in [Embedding.md](Embedding.md).
...
* [`httplib_get_context_user_data( ctx );`](api/httplib_get_context_user_data.md)
...
* [`httplib_get_thread_user_data( ctx );`](api/httplib_get_thread_user_data.md)
* [`httplib_start( options, callbacks, user_data );`](api/httplib_start.md)
...
* [`httplib_get_connection_user_data( conn );`](api/httplib_get_connection_user_data.md)
...
* [`httplib_set_connection_user_data( conn, data );`](api/httplib_set_connection_user_data.md)
